...
getRole = (req, res, next) => {
    ...
    Db.User.findOne({
        ...
        return res.status(401).end(`{msg:"user does not exist}`) 
    }) 
}
...
module.exports = {isAdmin, isFAA, getRole,verifyTwoFactorPin, updateTwoFactorPin, startTwoFactorSession, createPin, checkForToken, sendToken, createToken}